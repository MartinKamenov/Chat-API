...
const MORE_THAN_ONE_USER_FOUND_MESSAGE = 'There is more than one user with this id';
...
const PASSWORD_VALIDATION_MESSAGE = 'Password must be at 4 characters long';
const USERNAME_VALIDATION_MESSAGE = 'Username should consists only of letters and numbers';
